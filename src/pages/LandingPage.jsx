...
export function LandingPage() {
  ...
  return (
    <>
          ...
          <div className="contentMain flex flex-col items-center lg:flex-row justify-around">
            <div className="paragraphMain flex flex-col justify-center">
              ...
              <Typography
                variant="lead"
                color="blue-gray"
                className="mb-2 text-center lg:text-start tracking-wider"
              >
      ...
      <section className="pt-12 pb-40 relative">
        <div className="landingSvg2 separatorSvgTop"></div>
        <div className="mt-20 py-16">
          <Typography variant="h2" className="text-center lg:text-5xl mt-10">
            Proyectos Web
          </Typography>
