...
import "../css/ModeDark.css"
import { MainContext } from '../context/MainContext'

function ModeDark() {
    const {changeTheme, check} = useContext(MainContext)
  ...
  return (
     <label id="theme-toggle-button" onChange={handdleClick}>
   <input type="checkbox" id="toggle" checked={check}/>
